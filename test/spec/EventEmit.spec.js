...
var EventEmit = require('../../src/EventEmit');

describe('ok', function () {
  it('1', function () {
    var ee = new EventEmit();
...
//     });
//
//     it('1.3. on with context', function () {
//       var obj = {
//         foo: 'bar',
//         getFoo: function () {
//           __log.push(this.foo);
...
//     });
//
//     it('1.4. multiple messages on', function () {
...
//   });
//
//   describe('2. Unsubscribe', function () {
//     it('2.1. off', function () {
...
//     });
//
//     it('2.3. multiple messages off', function () {
//       Hub.on('message_1', function () {
...
//     });
//
//     it('2.4. off by handler and context', function () {
...
//     });
//
//     it('2.5. equal handlers off', function () {
//       var handler = function () {
//         __log.push('ok');
//       };
//
...
//   });
//
//   describe('3. Publish', function () {
//     it('3.1. order', function () {
//       Hub.trigger('message');
//
...
//     });
//
//     it('3.2. trigger multiple messages', function () {
//       Hub.on('message_1', function () {
//         __log.push('message_1');
//       });
//
...
//     });
//
//     it('3.3. message name in first argument', function () {
...
//     });
//
//     it('4.3. once with context', function () {
//       var obj = {
//         foo: 'bar',
//         getFoo: function () {
//           __log.push(this.foo);
...
//     });
//
//     it('4.4. multiple messages sub', function () {
